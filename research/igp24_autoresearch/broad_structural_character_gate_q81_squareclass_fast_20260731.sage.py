...
"""Run q81 lifts from the uniquely pinned 24T12302 parent."""
...
def load_base():
    spec = importlib.util.spec_from_file_location("q81_fast_base", BASE)
...
BASE_MODULE.QUOTIENT_T = 81
BASE_MODULE.QUOTIENT_ORDER = 144
BASE_MODULE.SOURCE_LABEL = "24T12302"
