...
"""Run q236 lifts from uniquely pinned parents with compact squareclasses."""
...
def load_base():
    spec = importlib.util.spec_from_file_location("q236_fast_broad", BASE_PATH)
    if spec is None or spec.loader is None:
        raise RuntimeError(f"cannot import {BASE_PATH}")
    module = importlib.util.module_from_spec(spec)
    spec.loader.exec_module(module)
    module.QUOTIENT_T = 236
    module.QUOTIENT_ORDER = 2304
    return module
