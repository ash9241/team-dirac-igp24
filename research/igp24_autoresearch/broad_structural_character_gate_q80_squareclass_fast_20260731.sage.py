...
"""Run q80 lifts from the uniquely pinned 24T12295 parent."""
...
def load_base():
    spec = importlib.util.spec_from_file_location("q80_fast_base", BASE)
...
BASE_MODULE.QUOTIENT_T = 80
BASE_MODULE.QUOTIENT_ORDER = 144
BASE_MODULE.SOURCE_LABEL = "24T12295"
