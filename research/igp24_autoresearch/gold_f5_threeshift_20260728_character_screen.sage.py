...
"""Resolve and tc0-screen exact three-shift derivative-character hits."""
...
DATA = ROOT / "data"
INPUT = DATA / "gold_f5_threeshift_20260728_character_scan.json"
RESULTS = DATA / "gold_f5_threeshift_20260728_character_screen.jsonl"
SUMMARY = DATA / "gold_f5_threeshift_20260728_character_screen_summary.json"
MANIFEST = ROOT / "outbox" / "gold_f5_threeshift_20260728_character_screen.txt"
RESERVED = {
    ("24T10482", 8),
    ("24T11787", 12),
    ("24T14293", 16),
...
def arithmetic_transform(
    quotient_line: str, a: int, b: int, c: int
) -> dict:
...
def main() -> int:
    ...
    summary = {
        "schemaVersion": "gold-f5-threeshift-20260728-character-screen-v1",
