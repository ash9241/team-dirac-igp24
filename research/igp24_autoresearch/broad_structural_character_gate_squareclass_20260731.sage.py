...
"""Run the broad structural gate with exact compact squareclass generators."""
...
def squareclass_compact_ideal_generator(ideal):
    """Return the exact compact principal generator modulo squares."""
    try:
...
def load_driver():
    spec = importlib.util.spec_from_file_location(
        "broad_squareclass_driver", DRIVER_PATH
    )
...
if __name__ == "__main__":
    ...
    raise SystemExit(load_driver().main())
